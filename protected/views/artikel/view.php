...
array(
			'name' => 'artikelTyp',
			'type' => 'raw',
			'value' => $model->artikelTyp !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->artikelTyp)), array('tblArtikelTyp/view', 'id' => GxActiveRecord::extractPkValue($model->artikelTyp, true))) : null,
			),
'name',
'bemerkung',
	),
